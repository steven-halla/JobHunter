package com.stevenhalla.spring.login.security;

import com.stevenhalla.spring.login.security.jwt.AuthEntryPointJwt;
import com.stevenhalla.spring.login.security.jwt.AuthTokenFilter;
import com.stevenhalla.spring.login.security.services.UserDetailsServiceImpl;
...
//  }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors().and()
                ...
                .antMatchers("/api/jobs/user/**").permitAll()
                .anyRequest().authenticated();
